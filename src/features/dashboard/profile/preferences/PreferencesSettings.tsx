  ...
  return (
    <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl shadow-sm overflow-hidden">
      <div className="px-5 py-4 border-b border-[var(--color-border)]">
        <p className="text-[11px] font-bold tracking-widest text-[var(--color-text-tertiary)] uppercase mb-3">Language</p>
      ...
      {[
        ...
        <div key={label} className="flex items-center gap-4 px-5 py-4 border-b last:border-0 border-[var(--color-border)]">
