      ...
      <div className="bg-[var(--color-primary)] rounded-2xl p-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-blue-100 text-[13px] mb-5 leading-relaxed max-w-sm mx-auto">
            Invite friends to Mohan Cabs. When they complete their first ride,
            you both get ₹100 off.
          </p>
          <div className="bg-white/20 rounded-xl p-3 flex items-center gap-3 mb-4">
            <p className="flex-1 text-[22px] font-black text-white tracking-widest">
              {REFERRAL_CODE}
            </p>
            <Button
              onPress={handleCopy}
          ...
          referrals.map((r) => (
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-[13px] font-bold text-primary">{r.name}</p>
