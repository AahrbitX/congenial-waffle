...
const BOOK_A_RIDE = [
  {
    Icon: Car,
    label: "City Taxi",
    desc: "Quick rides within Trivandrum",
    href: "/services/city-taxi",
  },
  {
    Icon: Key,
    label: "Rent a Car",
    desc: "Self-drive options",
    href: "/services/rent-a-car",
  },
  {
    Icon: Navigation,
    label: "Outstation",
    desc: "Inter-city travel packages",
    href: "/services/outstation",
  },
  {
    Icon: Plane,
    label: "Airport Transfer",
    desc: "Reliable pickup & drop",
    href: "/services/airport",
  },
  {
    Icon: Train,
    label: "Railway Transfer",
    desc: "Station pickup & drop",
    href: "/services/railway",
  },
  {
    Icon: Globe,
    label: "Nationwide Pickup",
    desc: "Anywhere to Trivandrum",
...
const SPECIAL_SERVICES = [
  {
    Icon: Heart,
    label: "Wedding Cars",
    desc: "Luxury fleet for events",
    href: "/services/wedding",
  },
  {
    Icon: Users,
    label: "Tempo Traveller",
    desc: "Group travel solutions",
    href: "/services/tempo",
  },
  {
    Icon: Briefcase,
    label: "Corporate",
    desc: "Business transport",
    ...
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-7xl">
      <div className="px-1 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link
            href="/"
            className="flex items-center gap-1.5 shrink-0 pl-2 pr-3 py-1.5 border border-border bg-background rounded-full"
          >
            <Image
          ...
          {session?.user ? (
            <div className="space-y-1">
              ...
              <Link
                href="/dashboard"
                onClick={() => setIsOpen(false)}
                className="flex items-center gap-2 px-3 py-2.5 text-sm font-medium rounded-lg text-primary hover:bg-primary-soft transition-colors"
              >
