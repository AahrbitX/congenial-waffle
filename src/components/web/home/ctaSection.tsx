...
function CtaSection() {
  return (
    <div className="px-6 sm:px-12 pt-5 pb-10">
        ...
        <div className="bg-accent rounded-3xl px-10 sm:px-16 py-16 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-start sm:items-end gap-3 shrink-0">
            ...
            <Link href="/login">
              <Button
                variant="secondary"
                className="flex items-center gap-2 px-8 py-3.5 rounded-full bg-white text-accent font-extrabold text-[15px] border-none hover:bg-white/90 h-auto"
              >
                Create Free Account
                <ArrowRight size={16} />
              </Button>
